  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Left Dark Gradient Overlay for perfect typography legibility matching the picture */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#14100D]/90 via-[#16120F]/70 to-transparent lg:w-2/3" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="max-w-2xl">
          ...
          {/* Main Headline */}
          <h1 className="text-4xl sm:text-5xl lg:text-[62px] font-serif font-bold text-white tracking-tight leading-[1.12] mb-6">
